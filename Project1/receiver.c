...
int main(int argc, char *argv[])
{
    ...
    /* RECEIVE SET UP PACKAGE */
    printf("Preparing to receive SET UP package\n");
    ...
    while (STOP == FALSE)
    {
		...
		// Check if it is a SET UP package
        if (bufrec[0] == 0x7E && bufrec[2] == 0x03){
            STOP = TRUE;
	...
	/* SEND UA PACKAGE */
	printf("Preparing to send UA package\n");
